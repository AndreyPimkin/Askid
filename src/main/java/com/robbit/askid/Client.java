...
public class Client {
    ...
    @FXML private ComboBox<String> boxCon;
    @FXML private ComboBox<String> boxDoc;
    @FXML private DatePicker dateClient;
    @FXML private DatePicker dateDoc;
    @FXML private Button buyButton;
    @FXML private TableColumn<Product, String> dateProduct;
    @FXML
    private TableColumn<Treaty, String> dateTreaty;
    @FXML private Button exitButton;
    @FXML private TextField linkCon;
    @FXML private TableColumn<Product, String> nameProduct;
    @FXML private TableColumn<Treaty, String> nameTreaty;
    @FXML private TextField nameUser;
    @FXML private TextField numberCon;
    @FXML private TextField numberDoc;
    @FXML private TableColumn<Treaty, String> numberTreaty;
    @FXML private TextField patronymicUser;
    @FXML private TableColumn<Product, String> price;
    @FXML private Button saveButton;
    @FXML private TableColumn<Treaty, String> statusTreaty;
    @FXML private TableColumn<Treaty, String> dateTreatyTo;
    @FXML private TextField surnameUser;
    @FXML private TableView<Product> tableProduct;
    @FXML private TableView<Treaty> tableTreaty;
            ...
            resultClient = dbHandler.getClient();
                    try {
                        if (resultClient.next()){
                            ...
                            try {dbHandler.addTreatyClient(product, treaty);
        ...
        saveButton.setOnAction(actionEvent -> {
            ...
            if (!nameUserText.equals("") && !surnameUserText.equals("") && !patronymicUserText.equals("") && dateClient.getValue() != null ||
                ...
                if (!nameUserText.equals("") && !surnameUserText.equals("") && !patronymicUserText.equals("") && dateClient.getValue() != null) {
                    ...
                    try {dbHandler.addPersonal(forClient);
                    } catch (SQLException | ClassNotFoundException e) {
                        e.printStackTrace();}}
                if ((!linkConText.equals("") || !numberConText.equals("")) && !selectContact.equals("") && con == 0) {
                    ...
                    try {dbHandler.addCon(forClient);
                    } catch (SQLException | ClassNotFoundException e) {
                        e.printStackTrace();}
                    con = 1;}
                if (!numberDocText.equals("") && dateDoc.getValue() != null && !selectDocument.equals("") && doc == 0) {
                    ...
                    forClient.setIdClient(AuthorizationController.id_client);
                    try {dbHandler.addDoc(forClient);
                    } catch (SQLException | ClassNotFoundException e) {
                        e.printStackTrace();}
                    doc = 1;}
                text.setText("Данные обновлены");}
            else {text.setText("Присутсвутют пустые данные");}});}
